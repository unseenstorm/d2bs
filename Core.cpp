...
} ///removed say for now use public void addEventListener(String event,Function eventHandler) & public int sendCopyData(String windowClassName,String windowName,int32_t nModeId,String data)
*/
